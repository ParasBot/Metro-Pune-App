...
import java.util.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("PCMC~B");
			g.addVertex("Hinjewadi Phase 3~B");
			g.addVertex("Shivajinagar~B");
			g.addVertex("Swargate~BY");
			g.addVertex("Vanaz~B");
			g.addVertex("Nal Stop~B");
			g.addVertex("Kothrud~BO");
			g.addVertex("Warje~B");
			g.addVertex("Hadapsar~Y");
			g.addVertex("Magarpatta~Y");
			g.addVertex("Koregaon Park~Y");
			g.addVertex("Bund Garden~Y");
			g.addVertex("Pune Railway Station~YO");
			g.addVertex("Yerwada~Y");
			g.addVertex("Viman Nagar~O");
			g.addVertex("Kharadi~O");
			g.addVertex("Pune Airport~O");
			g.addVertex("Bhosari~BP");
			g.addVertex("Alandi~PR");
			g.addVertex("Dighi~P");
		
			g.addEdge("PCMC~B", "Hinjewadi Phase 3~B", 8);
			g.addEdge("Hinjewadi Phase 3~B", "Shivajinagar~B", 10);
			g.addEdge("Shivajinagar~B", "Vanaz~B", 8);
			g.addEdge("Shivajinagar~B", "Swargate~BY", 6);
			g.addEdge("Swargate~BY", "Nal Stop~B", 9);
			g.addEdge("Nal Stop~B", "Kothrud~BO", 7);
			g.addEdge("Kothrud~BO", "Warje~B", 6);
			g.addEdge("Hadapsar~Y", "Magarpatta~Y", 15);
			g.addEdge("Magarpatta~Y", "Yerwada~Y", 6);
			g.addEdge("Yerwada~Y", "Swargate~BY", 7);
			g.addEdge("Swargate~BY", "Pune Railway Station~YO", 1);
			g.addEdge("Pune Railway Station~YO", "Bund Garden~Y", 2);
			g.addEdge("Bund Garden~Y", "Koregaon Park~Y", 5);
			g.addEdge("Pune Railway Station~YO", "Viman Nagar~O", 2);
			g.addEdge("Viman Nagar~O", "Kharadi~O", 7);
			g.addEdge("Kharadi~O", "Pune Airport~O", 8);
			g.addEdge("Nal Stop~B", "Bhosari~BP", 2);
			g.addEdge("Dighi~P", "Bhosari~BP", 2);
			g.addEdge("Dighi~P", "Alandi~PR", 3);
		}		
